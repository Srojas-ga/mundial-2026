        ...
        <div class="flex-1">
          ...
          <div *ngIf="activeTab() === 'profile'" class="bg-white rounded-xl shadow-md border border-gray-100 p-8">
            ...
            <div class="flex items-center gap-6 mb-8 pb-8 border-b border-gray-200">
              <div class="w-24 h-24 bg-gradient-to-br from-[#00B140] to-[#003087] rounded-full flex items-center justify-center text-5xl">
                {{ data.currentUser.avatar }}
              </div>
              <div>
                <h3 class="text-xl mb-1 text-gray-800">{{ data.currentUser.name }}</h3>
                <p class="text-gray-600 text-sm">{{ data.currentUser.email }}</p>
                <button class="mt-3 px-4 py-1.5 text-sm border-2 border-[#00B140] text-[#00B140] rounded-lg hover:bg-[#00B140] hover:text-white transition-colors">
                  Cambiar foto
                </button>
              </div>
            </div>
            ...
            <div class="space-y-6">
              <div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  <label *ngFor="let team of data.teams"
          ...
          <div *ngIf="activeTab() === 'security'" class="bg-white rounded-xl shadow-md border border-gray-100 p-8">
            ...
            <div class="space-y-6">
              ...
              <div class="pt-6 border-t border-gray-200">
                ...
                <button class="px-4 py-2.5 border-2 border-[#003087] text-[#003087] rounded-lg hover:bg-[#003087] hover:text-white transition-colors">
                  Activar 2FA
                </button>
              </div>
...
export class SettingsComponent {
  ...
  profileForm = {
    nombre:   this.data.currentUser.name.split(' ')[0],
    apellidos: this.data.currentUser.name.split(' ').slice(1).join(' '),
  ...
  favoriteTeams:  string[] = [...this.data.currentUser.favoriteTeams];
  favoriteCities: string[] = [...this.data.currentUser.cities];
  ...
  saveProfile() { this.toast(this.savedProfile); }
  saveNotif()   { this.toast(this.savedNotif); }
  savePrefs()   { this.toast(this.savedPrefs); }
