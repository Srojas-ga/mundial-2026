  ...
  template: `
    <div class="space-y-6">
      ...
      <div *ngIf="activeTab() === 'cases'" class="space-y-4">
        ...
        <ng-container *ngIf="data.cases.length > 0; else noCases">
          <div *ngFor="let caso of data.cases"
...
export class SupportComponent {
  ...
  get openCases()     { return this.data.cases.filter(c => c.status === 'open' || c.status === 'in-progress'); }
  get resolvedCases() { return this.data.cases.filter(c => c.status === 'resolved' || c.status === 'closed'); }
