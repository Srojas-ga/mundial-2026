          ...
          <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-4">
              ...
              <a routerLink="/settings" class="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg transition-colors">
                ...
                <span class="hidden sm:inline text-sm text-gray-700">{{ currentUser?.name || 'Usuario' }}</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <aside class="hidden lg:block w-64 min-h-[calc(100vh-4rem)] p-6">
          <nav class="space-y-2">
            ...
            <div class="pt-6 mt-6 border-t border-gray-200">
              ...
              <a (click)="logout()" class="cursor-pointer flex items-center gap-3 px-4 py-3 rounded-lg text-red-600 hover:bg-red-50 transition-all duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round"
